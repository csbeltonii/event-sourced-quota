...
public class QuotaCell(string quotaTableName, string projectId, string userId) : Entity(userId)
{
    [JsonConstructor]
    private QuotaCell() : this(string.Empty, string.Empty, string.Empty) { }
